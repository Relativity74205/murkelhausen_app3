...
class AppointmentRecurrence:
    ...
    def from_string(cls, recurrence_string: str) -> "AppointmentRecurrence":
        ...
        count = recurrence_dict.get("COUNT")
...
def get_google_calendar_client() -> GoogleCalendar:
    private_key = GOOGLE_CALENDAR_SETTINGS.api_key.replace("\\n", "\n")
    info = {
        "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
        "auth_uri": "https://accounts.google.com/o/oauth2/auth",
        "client_email": GOOGLE_CALENDAR_SETTINGS.client_email,
        "client_id": GOOGLE_CALENDAR_SETTINGS.client_id,
        "client_x509_cert_url": GOOGLE_CALENDAR_SETTINGS.client_x509_cert_url,
        "private_key": private_key,
        "private_key_id": GOOGLE_CALENDAR_SETTINGS.private_key_id,
        "project_id": GOOGLE_CALENDAR_SETTINGS.project_id,
...
if __name__ == "__main__":
    events = [
        ...
        for event in get_list_of_appointments(
            GOOGLE_CALENDAR_SETTINGS.calendars["Arkadius"],
            "Arkadius",
            amount_of_days_to_show=14,
        )
    ]
